...
% AR: adjusted Rand - Hubert & Arabie 1985
% RI: Probability of agreement Rand 1971
% MI: p(disagreement)
% HI: p(agree)-p(disagree)
...
%
% See L. Hubert and P. Arabie (1985)index "Comparing Partitions" Journal of 
